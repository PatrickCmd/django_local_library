# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-28 22:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text="Enter the book's natural language (e.g English, French, Spanish etc.)", max_length=200)),
            ],
        ),
        migrations.AddField(
            model_name='book',
